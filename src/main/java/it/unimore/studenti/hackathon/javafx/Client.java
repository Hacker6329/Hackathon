package it.unimore.studenti.hackathon.javafx;

import it.italiandudes.idl.common.Logger;
import it.unimore.studenti.hackathon.javafx.components.SceneController;
import it.unimore.studenti.hackathon.javafx.scenes.SceneMainMenu;
...
public final class Client extends Application {
    ...
    public void start(Stage stage) {
        ...
        stage.getScene().getStylesheets().add(JFXDefs.Resources.CSS.CSS_THEME);
